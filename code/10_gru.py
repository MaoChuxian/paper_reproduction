...
output_dir = results_dir / "10_1_GRU"
...
result.to_excel(
    output_dir / "10_1_GRU_metrics.xlsx",
    index=False,
)

pd.DataFrame(records).sort_values("RMSE").to_excel(
    output_dir / "10_1_GRU_tuning.xlsx",
    index=False,
)

prediction_df = val_df.copy()
prediction_df["Pred_GRU"] = best_pred
prediction_df.to_excel(
    output_dir / "10_1_GRU_predictions.xlsx",
    index=False,
)

torch.save(
    best_model.state_dict(),
    output_dir / "10_1_GRU.pt",
)

plot_result(
    y_val.squeeze(1).numpy(),
    best_pred,
    output_dir / "10_1_GRU.png",
    "a",
)