...
output_dir = results_dir / "09_3_Ridge"
...
for alpha in np.logspace(-8, 4, 70):
...
result.to_excel(
    output_dir / "09_3_Ridge_metrics.xlsx",
    index=False,
)

pd.DataFrame(records).to_excel(
    output_dir / "09_3_Ridge_tuning.xlsx",
    index=False,
)

prediction_df = val_df.copy()
prediction_df["Pred_Ridge"] = best_pred
prediction_df.to_excel(
    output_dir / "09_3_Ridge_predictions.xlsx",
    index=False,
)

joblib.dump(
    best_model,
    output_dir / "09_3_Ridge.joblib",
)
