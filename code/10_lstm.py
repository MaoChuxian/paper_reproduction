...
output_dir = results_dir / "10_2_LSTM"
...
configs = [
    {"hidden_size": 32, "lr": 0.001, "weight_decay": 1e-4},
    {"hidden_size": 64, "lr": 0.001, "weight_decay": 1e-4},
    {"hidden_size": 64, "lr": 0.0005, "weight_decay": 1e-4},
]
...
result.to_excel(
    output_dir / "10_2_LSTM_metrics.xlsx",
    index=False,
)

pd.DataFrame(records).sort_values("RMSE").to_excel(
    output_dir / "10_2_LSTM_tuning.xlsx",
    index=False,
)

prediction_df = val_df.copy()
prediction_df["Pred_LSTM"] = best_pred
prediction_df.to_excel(
    output_dir / "10_2_LSTM_predictions.xlsx",
    index=False,
)

torch.save(
    best_model.state_dict(),
    output_dir / "10_2_LSTM.pt",
)

plot_result(
    y_val.squeeze(1).numpy(),
    best_pred,
    output_dir / "10_2_LSTM.png",
    "b",
)