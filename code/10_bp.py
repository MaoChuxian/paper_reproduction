...
output_dir = results_dir / "10_4_BP"
...
configs = [
    {"hidden1": 32, "hidden2": 16, "lr": 0.001, "weight_decay": 1e-4},
    {"hidden1": 64, "hidden2": 32, "lr": 0.001, "weight_decay": 1e-4},
    {"hidden1": 128, "hidden2": 64, "lr": 0.0005, "weight_decay": 1e-4},
]
...
result.to_excel(
    output_dir / "10_4_BP_metrics.xlsx",
    index=False,
)

pd.DataFrame(records).sort_values("RMSE").to_excel(
    output_dir / "10_4_BP_tuning.xlsx",
    index=False,
)

prediction_df = val_df.copy()
prediction_df["Pred_BP"] = best_pred
prediction_df.to_excel(
    output_dir / "10_4_BP_predictions.xlsx",
    index=False,
)

torch.save(
    best_model.state_dict(),
    output_dir / "10_4_BP.pt",
)

plot_result(
    y_val.squeeze(1).numpy(),
    best_pred,
    output_dir / "10_4_BP.png",
    "d",
)